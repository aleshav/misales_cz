...
$mail->From     = "rsvp@misales.cz";// emaill address from your site
$mail->FromName = "RSVP"; // Subject of the mail
$mail->AddAddress("rsvp@misales.cz","Name 1"); // Put your email here
...
if(!$mail->Send()) {
	$recipient = 'rsvp@misales.cz'; //Put your email here
	$subject = 'Contact form failed';
	$content = $body;	
  mail($recipient, $subject, $content, "From: rsvp@misales.cz\r\nReply-To: $email\r\nX-Mailer: DT_formmail");
  exit;
}
?>
